<template>
  <div>
    <div>
      <div class="mt-2">
        <input placeholder=" Candidate ID" v-model="candidate_id" type="text" name="email" id="email"
          class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
      </div>
      <div class="mt-2">
        <input placeholder=" JOB POSTING ID" v-model="job_posting_id" type="text" name="email" id="email"
          class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
      </div>
      <div class="mt-2">
      ...
      <div class="mt-2">
        <input placeholder=" RESUME URL" v-model="resume_url" type="text" name="email" id="email"
          class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
      </div>
      <div class="mt-2">
        <input placeholder=" COVER LETTER" v-model="cover_letter" type="text" name="email" id="email"
          class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
      </div>
    </div>
...
// Define emit events
const emit = defineEmits(["hide", 'addApplication']);
// Close modal
...
if(data)  emit("addApplication", data);
};
</script>
